...
const defaultMeals: Meal[] = [
  { id: 1, name: "Pasta Primavera", emoji: "🍝", time: "Mon", prepTime: "25 min", tags: ["Vegetarian", "Quick"], ingredients: ["Penne pasta", "Zucchini", "Bell peppers", "Parmesan", "Olive oil"], servings: 4, calories: 420, protein: 14, carbs: 62, fat: 12 },
  { id: 2, name: "Taco Night", emoji: "🌮", time: "Tue", prepTime: "20 min", tags: ["Family Fave", "Quick"], ingredients: ["Ground beef", "Taco shells", "Salsa", "Sour cream", "Lettuce", "Cheese"], servings: 4, calories: 550, protein: 28, carbs: 45, fat: 22 },
  { id: 3, name: "Grilled Chicken", emoji: "🍗", time: "Wed", prepTime: "35 min", tags: ["High Protein", "Healthy"], ingredients: ["Chicken breast", "Broccoli", "Lemon", "Garlic", "Olive oil"], servings: 4, calories: 380, protein: 42, carbs: 18, fat: 14 },
  { id: 4, name: "Shrimp Stir Fry", emoji: "🥢", time: "Thu", prepTime: "20 min", tags: ["Seafood", "Quick"], ingredients: ["Shrimp", "Snap peas", "Carrots", "Soy sauce", "Ginger", "Rice"], servings: 4, calories: 410, protein: 32, carbs: 48, fat: 8 },
  { id: 5, name: "Homemade Pizza", emoji: "🍕", time: "Fri", prepTime: "45 min", tags: ["Family Fave", "Fun"], ingredients: ["Pizza dough", "Mozzarella", "Tomato sauce", "Bell peppers", "Mushrooms"], servings: 4, calories: 620, protein: 24, carbs: 78, fat: 22 },
  { id: 6, name: "BBQ Ribs", emoji: "🍖", time: "Sat", prepTime: "2 hr", tags: ["Weekend", "Indulgent"], ingredients: ["Pork ribs", "BBQ sauce", "Corn on cob", "Coleslaw"], servings: 4, calories: 780, protein: 48, carbs: 42, fat: 38 },
  { id: 7, name: "Slow Cooker Chili", emoji: "🫕", time: "Sun", prepTime: "6 hr", tags: ["Comfort Food", "Meal Prep"], ingredients: ["Ground beef", "Kidney beans", "Tomatoes", "Chili powder", "Onion"], servings: 6, calories: 490, protein: 34, carbs: 52, fat: 16 },
];
