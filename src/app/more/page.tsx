...
export default function MorePage() {
  return (
    <PageShell>
      <PageHeader title="More" subtitle="Calendar and Emergency reference tools" />
      <div className="px-4 space-y-4 pb-8">
        ...
        <Surface variant="glass-subtle" radius="xl" padding="lg">
          ...
          <p className="mt-2 text-sm leading-6 text-text-secondary">
            Home, Ask Consuela, Meals, Tasks, and Settings are the five primary family workflows. Calendar and Emergency stay one tap away here to keep the bottom bar calm and thumb-friendly. The grocery list lives inside the Meals tab.
          </p>
        </Surface>
      </div>
    </PageShell>
