...
export type HolidayOverride = 'auto' | 'none' | 'christmas' | 'halloween' | 'july4th' | 'valentines' | 'newyears' | 'cincodemayo' | 'thanksgiving' | 'stpatricks' | 'diadelosmuertos' | 'mexicanindependence' | 'virginguadalupe';
