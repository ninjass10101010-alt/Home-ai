...
- ✅ Add tasks, grocery items, and calendar events — **these now really write to PocketBase** (native OpenAI tool-calling since 2026-08-05: "add milk to the grocery list" lands a real grocery row)
